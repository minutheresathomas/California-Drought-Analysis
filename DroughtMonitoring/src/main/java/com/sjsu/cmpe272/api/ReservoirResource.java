...
public class ReservoirResource {
	private final JacksonDBCollection<Reservoir, String> reservoir;
	 ...
	 * @param reservoirs
	 */
	public ReservoirResource(JacksonDBCollection<Reservoir, String> reservoir, 
...
//        reservoirs.save(request);
        ...
        {
        	reservoir.insert(allReservoirs.get(i));
        }
	...
	@Path("getALM")
	@Timed(name="get")
	public List<Reservoir> getReservoirAlm() throws ParseException
	{
		System.out.println("call the tmethod");
		List<Reservoir> map= reservoirRepository.getReservoirs();
		System.out.println("Getting the hashmap");
		return map;
	}
