...
public class DroughtMonitoring extends Service<DroughtMonitoringConfiguration>{
					...
					Environment environment) throws UnknownHostException
	{
        ...
        JacksonDBCollection<Reservoir, String> reservoirs =
                JacksonDBCollection.wrap(db.getCollection("reservoir"), Reservoir.class, String.class);
        ...
        environment.addResource(new ReservoirResource(reservoirs, reservoirRepository));
